  ...
  return (
    <section id="credentials" className="py-12 md:py-20 lg:py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {academicCredentials.map((credential, index) => (
              <div key={index} className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 border border-purple-100 hover:border-purple-300 transition-all hover:shadow-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-700 font-medium mb-1">{credential.institution}</p>
        ...
        {/* TV & Media */}
        <div className="mb-16 bg-gradient-to-br from-slate-900 to-purple-900 rounded-3xl p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {mediaPresence.map((media, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                ...
                <p className="text-purple-200 font-medium mb-2">{media.show}</p>
